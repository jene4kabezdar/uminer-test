<?php /* Smarty version Smarty-3.1.13, created on 2023-06-27 11:28:29
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10329995606494000135c6e8-68547767',
  'function' => 
  array (
    'layout_footer_links' => 
    array (
...
">
    ...
    <?php echo smarty_function_lang(array('_default_short'=>'plugin.order.page_order_title'),$_smarty_tpl);?>
...
?>
    ...
    <div class="container pluginator mb-3">
        ...
        <?php $_smarty_tpl->tpl_vars['items'] = new Smarty_variable(array(array('icon'=>'edit','url'=>$_smarty_tpl->tpl_vars['order']->value->getUrlEdit(),'text'=>$_smarty_tpl->tpl_vars['aLang']->value['common']['edit']),array('icon'=>'trash','url'=>"#",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['common']['remove'],'classes'=>'ls-button--danger js-order-list-item-delete')), null, 0);?>
        <?php echo smarty_function_component(array('_default_short'=>'actionbar','classes'=>"order-actions",'items'=>array(array('buttons'=>$_smarty_tpl->tpl_vars['items']->value))),$_smarty_tpl);?>
