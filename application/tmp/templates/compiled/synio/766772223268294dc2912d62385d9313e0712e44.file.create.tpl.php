...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '192898802964940011573876-56161894',
  'function' => 
  array (
    'layout_footer_links' => 
    array (
...
<?php echo smarty_function_component_define_params(array('params'=>array('mods','classes','attributes')),$_smarty_tpl);?>
    ...
    <?php $_smarty_tpl->tpl_vars['tagPageTitle'] = new Smarty_variable('h3', null, 0);?>
    <?php $_smarty_tpl->tpl_vars['layoutHideBreadcrumb'] = new Smarty_variable(false, null, 0);?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['order']->value){?>
        <?php echo smarty_function_lang(array('_default_short'=>'plugin.order.form_title_update'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->tpl_vars['order']->value->getTitle();?>

    <?php }else{ ?>
        <?php echo smarty_function_lang(array('_default_short'=>'plugin.order.form_title_create'),$_smarty_tpl);?>
...
?>
    ...
    <div class="container pluginator mb-3">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="syn-form-panel js-form-order"
              data-action="<?php echo $_smarty_tpl->tpl_vars['order']->value ? 'update' : 'create';?>
">
            <?php if ($_smarty_tpl->tpl_vars['order']->value){?>
                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['order']->value ? $_smarty_tpl->tpl_vars['order']->value->getId() : '';?>
">
            <?php }?>

            <div class="ls-field  ls-clearfix   mb-3">
                <label class="ls-field-label" for="order-title"><?php echo smarty_function_lang(array('_default_short'=>'plugin.order.label_title'),$_smarty_tpl);?>
</label>
                <div class="ls-field-holder">
                    <input type="text" name="order[title]" class="ls-field-input  form-control" id="order-title"
                           value="<?php echo $_smarty_tpl->tpl_vars['order']->value ? $_smarty_tpl->tpl_vars['order']->value->getTitle() : '';?>
">
                </div>
                <small class="ls-field-note js-ls-field-note text-danger"><?php echo smarty_function_lang(array('_default_short'=>'plugin.order.note_title'),$_smarty_tpl);?>
</small>
            </div>

            <div class="mb-3">
                <?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'plugin.order.label_text'),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'plugin.order.note_text'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'editor','name'=>'order[text_source]','value'=>($_smarty_tpl->tpl_vars['order']->value ? $_smarty_tpl->tpl_vars['order']->value->getTextSource() : ''),'label'=>$_tmp1,'note'=>$_tmp2,'entityField'=>'text_source','entity'=>'PluginOrder_ModuleOrder_EntityOrder','classes'=>'order-field-text mb-3','inputClasses'=>'js-editor-default','mediaTargetType'=>'topic','mediaTargetId'=>$_smarty_tpl->tpl_vars['order']->value ? $_smarty_tpl->tpl_vars['order']->value->getId() : ''),$_smarty_tpl);?>
            ...
            <div class="ls-field ls-field--checkbox  ls-clearfix   form-check mb-3">
                <div class="ls-field-holder">
                    <input type="checkbox" class="ls-field-input  form-check-input" name="active"
                           id="order-active" <?php echo $_smarty_tpl->tpl_vars['order']->value&&$_smarty_tpl->tpl_vars['order']->value->getStatus() ? 'checked' : '';?>
>
                </div>
